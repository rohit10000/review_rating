 ...
 */
export declare interface AnalyzeSentimentResultCollection extends Array<AnalyzeSentimentResult> {
    /**
 ...
 * annotated with information about the batch operation.
 */
export declare interface DetectLanguageResultCollection extends Array<DetectLanguageResult> {
    /**
     * Statistics about the input document batch and how it was processed
     * by the service. This property will have a value when includeStatistics is set to true
     * in the client call.
 ...
 * annotated with information about the batch operation.
 */
export declare interface ExtractKeyPhrasesResultCollection extends Array<ExtractKeyPhrasesResult> {
    /**
     * Statistics about the input document batch and how it was processed
     * by the service. This property will have a value when includeStatistics is set to true
     * in the client call.
 ...
 * annotated with information about the batch operation.
 */
export declare interface RecognizeCategorizedEntitiesResultCollection extends Array<RecognizeCategorizedEntitiesResult> {
    /**
     * Statistics about the input document batch and how it was processed
     * by the service. This property will have a value when includeStatistics is set to true
     * in the client call.
 ...
 * annotated with information about the batch operation.
 */
export declare interface RecognizeLinkedEntitiesResultCollection extends Array<RecognizeLinkedEntitiesResult> {
    /**
     * Statistics about the input document batch and how it was processed
     * by the service. This property will have a value when includeStatistics is set to true
     * in the client call.
 ...
 * annotated with information about the batch operation.
 */
export declare interface RecognizePiiEntitiesResultCollection extends Array<RecognizePiiEntitiesResult> {
    /**
     * Statistics about the input document batch and how it was processed
     * by the service. This property will have a value when includeStatistics is set to true
     * in the client call.
